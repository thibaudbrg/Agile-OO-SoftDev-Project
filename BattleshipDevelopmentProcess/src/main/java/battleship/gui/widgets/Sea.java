...
public class Sea extends Pane {
    ...
    public Sea() {
        ...
        setBackground(
                new Background(
                        new BackgroundImage(
                                new Image(Objects.requireNonNull(Sea.class.getClassLoader().getResourceAsStream("assets/background.png"))),
    ...
    public void addShip(Ship ship, Coordinates coordinates) {
        ship.relocate(coordinates.getCol() * Tile.SIZE + offsetX, coordinates.getRow() * Tile.SIZE + offsetY);
