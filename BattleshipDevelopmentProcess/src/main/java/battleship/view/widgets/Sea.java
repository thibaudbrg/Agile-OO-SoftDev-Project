...
public class Sea extends Pane {
	...
	public Sea() {
		...
		setBackground(
				new Background(
						new BackgroundImage(
								new Image(Sea.class.getClassLoader().getResourceAsStream("/Users/sahbiabderrazak/Desktop/tout/DTU/agile OO software dev/Agile-OO-SoftDev-Project/BattleshipDevelopmentProcess/src/main/resources/assets/background.png")),
